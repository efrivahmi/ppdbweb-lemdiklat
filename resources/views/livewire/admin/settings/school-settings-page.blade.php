<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-lime-50 to-emerald-50 flex justify-between items-center">
            ...
            <div class="flex items-center gap-3 bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-100">
                <span class="text-sm font-medium text-gray-700">Status PPDB:</span>
                <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <span class="ml-3 text-sm font-medium {{ $is_ppdb_open ? 'text-lime-600' : 'text-red-500' }}">
