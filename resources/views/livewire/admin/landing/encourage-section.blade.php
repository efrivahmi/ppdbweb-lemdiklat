<div>
    <x-atoms.breadcrumb currentPath="Keunggulan Sekolah" />

    <x-atoms.card className="mt-3">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            <x-atoms.title text="Tabel Keunggulan Sekolah" size="xl" class="text-gray-900" />
                            ...
                            <td colspan="6" class="text-center px-6 py-8 text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <x-atoms.title size="md" class="text-gray-700 mb-2"
                                        :text="$search ? 'Tidak ditemukan keunggulan' : 'Belum ada data'" />
                                    <x-atoms.description class="text-gray-500">
                                        {{ $search ? 'Coba ubah kata kunci pencarian' : 'Mulai dengan menambahkan keunggulan sekolah' }}
                                    </x-atoms.description>
                                </div>
                            </td>
                        </tr>
        ...
        @if ($advantages->hasPages())
            <div class="mt-4 w-full flex justify-center">
                {{ $advantages->links('vendor.pagination.tailwind') }}
            </div>
        @endif
    </x-atoms.card>

    {{-- Modal Form --}}
    <x-atoms.modal name="advantage-modal" maxWidth="2xl" :closeable="true">
        <div class="flex justify-between items-center p-6 border-b border-gray-200">
            <x-atoms.title :text="$editMode ? 'Edit Keunggulan' : 'Tambah Keunggulan'" size="lg" class="text-gray-900" />
        </div>
        ...
        <div class="p-6 max-h-[60vh] overflow-y-auto">
            <form wire:submit.prevent="save" class="space-y-6">
                ...
                <x-molecules.input-field
                    ...
                    name="title"
                    placeholder="Contoh: Pendidikan Karakter Berbasis Kedisiplinan"
                    wire:model="title"
                ...
                <x-molecules.textarea-field
                    ...
                    name="description"
                    placeholder="Jelaskan keunggulan secara detail..."
                    :rows="5"
