        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                <h2 class="text-lg font-bold text-gray-800 flex items-center gap-2">
                    ...
                    Status Sistem Penerimaan Murid Baru (SPMB)
                </h2>
                <p class="text-sm text-gray-600 mt-1">Mengaktifkan atau menonaktifkan seluruh sistem pendaftaran SPMB. Jika ditutup, calon siswa tidak akan bisa mendaftar.</p>
            </div>
            
            <div class="flex items-center gap-3 bg-white px-5 py-3 rounded-xl shadow-sm border border-gray-100">
                <span class="text-sm font-bold text-gray-700">Status SPMB:</span>
