<div>
    ...
    <div class="bg-white border border-gray-300 shadow-md rounded-md mt-4">
        <div class="bg-gradient-to-r from-emerald-500 to-teal-600 text-white p-6 rounded-t-md">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <span class="inline-block mt-1 px-2 py-1 bg-emerald-400 bg-opacity-30 text-emerald-100 text-xs rounded-full">
                        Guru
                    </span>
                </div>
            </div>
        ...
        <div class="border-b border-gray-200">
            <nav class="flex space-x-8 px-6" aria-label="Tabs">
                <button wire:click="setActiveTab('profile')"
                    ...
                    {{ $activeTab === 'profile' ? 'border-emerald-500 text-emerald-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
                    <i class="ri-user-line mr-2"></i>
                    Informasi Profile
                </button>
                <button wire:click="setActiveTab('password')"
                    class="py-4 px-1 border-b-2 font-medium text-sm transition-colors
                    {{ $activeTab === 'password' ? 'border-emerald-500 text-emerald-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }}">
            ...
            @if ($activeTab === 'profile')
                <form wire:submit.prevent="updateProfile" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="name" id="name"
                                class="border border-gray-300 px-3 py-2 w-full rounded-md focus:outline-emerald-500 focus:border-emerald-500 transition @error('name') border-red-500 @enderror">
                            @error('name')
                                <span class="text-red-600 text-xs mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="email" wire:model="email" id="email"
                                class="border border-gray-300 px-3 py-2 w-full rounded-md focus:outline-emerald-500 focus:border-emerald-500 transition @error('email') border-red-500 @enderror">
                            @error('email')
                                <span class="text-red-600 text-xs mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="telp" id="telp" placeholder="Contoh: 08123456789"
                                class="border border-gray-300 px-3 py-2 w-full rounded-md focus:outline-emerald-500 focus:border-emerald-500 transition @error('telp') border-red-500 @enderror">
                            @error('telp')
                                <span class="text-red-600 text-xs mt-1 block">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="flex justify-end">
                        <button type="submit"
                            class="inline-flex items-center px-6 py-2 bg-emerald-600 text-white rounded-md hover:bg-emerald-700 transition"
                ...
                <form wire:submit.prevent="changePassword" class="space-y-6 max-w-md">
                    ...
                    <div>
                        ...
                        <input type="password" wire:model="current_password" id="current_password"
                            class="border border-gray-300 px-3 py-2 w-full rounded-md focus:outline-emerald-500 focus:border-emerald-500 transition @error('current_password') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="password" wire:model="new_password" id="new_password"
                            class="border border-gray-300 px-3 py-2 w-full rounded-md focus:outline-emerald-500 focus:border-emerald-500 transition @error('new_password') border-red-500 @enderror">
                        @error('new_password')
                            <span class="text-red-600 text-xs mt-1 block">{{ $message }}</span>
                        @endif
                    ...
                    <div>
                        ...
                        <input type="password" wire:model="new_password_confirmation" id="new_password_confirmation"
                            class="border border-gray-300 px-3 py-2 w-full rounded-md focus:outline-emerald-500 focus:border-emerald-500 transition">
                    </div>
