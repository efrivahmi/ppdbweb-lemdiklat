        ...
        <div class="space-y-4">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="flex flex-wrap gap-4 text-sm text-gray-500">
                                            ...
                                            <div class="flex items-center gap-1">
                                                ...
                                                <span>{{ $test->questions()->where('tipe_soal', 'text')->count() }} soal essay</span>
                                            </div>
                                            <div class="flex items-center gap-1">
            ...
            @else
                <div class="text-center py-16 flex justify-center flex-col items-center">
                    ...
                    <x-atoms.title text="Tidak Ada Test" size="xl" className="text-gray-500 mb-3" />
        ...
        <div class="space-y-4">
            ...
            @else
                <div class="text-center py-16">
                    ...
                    <x-atoms.title text="Tidak Ada Siswa" align="center" size="xl" className="text-gray-500 mb-3" />
                    <x-atoms.description color="gray-400" class="text-center w-full">
                        @if($searchUser)
        ...
        <div class="space-y-6">
            ...
            <x-atoms.card className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div class="text-center">
                            <div class="text-2xl font-bold text-yellow-600">{{ $userStats['essay_pending'] }}</div>
                            <div class="text-sm text-gray-600">Essay Pending</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-emerald-600">{{ $userStats['essay_approved'] }}</div>
                            <div class="text-sm text-gray-600">Essay Disetujui</div>
                        </div>
                    </div>
                    
                    <!-- Action Buttons -->
                    <div class="flex flex-wrap gap-3 mt-6 pt-6 border-t border-blue-200">
                        @if($userStats['essay_pending'] > 0)
                        <x-atoms.button
                            wire:click="approveAllEssayForUser"
                            wire:confirm="Yakin ingin menyetujui semua jawaban essay yang pending?"
                            variant="success"
                            theme="light"
                            size="sm"
                        ...
                        <x-atoms.button
                            ...
                            wire:confirm="Yakin ingin menolak semua jawaban essay yang pending?"
                            variant="danger"
                            theme="light"
                            size="sm"
                            heroicon="x-circle"
            ...
            @if(isset($userAnswers))
                ...
                <x-atoms.card className="border border-gray-200">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="border rounded-lg p-4 {{ $answer->is_correct ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50' }}">
                            ...
                            <div class="mb-3">
                                <x-atoms.description color="gray-700" size="sm" className="mb-2">
                                    {{ $answer->customTestQuestion->pertanyaan }}
                                </x-atoms.description>
                                
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                                    <div>
                                        <span class="font-medium">Jawaban siswa:</span> 
                                        <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded">{{ $answer->jawaban }}</span>
                                    </div>
                                    <div>
                                        <span class="font-medium">Jawaban benar:</span> 
                                        <span class="px-2 py-1 bg-green-100 text-green-800 rounded">{{ $answer->customTestQuestion->jawaban_benar }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="text-center py-16 flex justify-center flex-col items-center">
                    ...
                    <x-atoms.title text="Tidak Ada Jawaban" size="xl" className="text-gray-500 mb-3 text-center" />
                    <x-atoms.description color="gray-400" class="text-center max-w-md">
