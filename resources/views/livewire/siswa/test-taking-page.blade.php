            ...
            <div class="bg-white rounded-lg shadow-sm p-4 mb-6">
                ...
                <div class="flex flex-wrap gap-2">
                    @foreach($questions as $index => $question)
                        ...
                        @endphp
                        <button wire:click="goToQuestion({{ $index }})" class="relative w-10 h-10 rounded-lg text-sm font-medium transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-opacity-50
                                       @if($status === 'current')
                    ...
                    <div class="mb-8">
                        <div class="flex items-start gap-4">
                            <div class="flex-shrink-0">
                                <span
                                    class="inline-flex items-center justify-center w-10 h-10 bg-gradient-to-r from-lime-500 to-green-600 text-white rounded-full text-sm font-bold">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                        @if($currentQuestionIndex === count($questions) - 1)
                            <button wire:click="submitTest"
                                ...
                                wire:loading.attr="disabled" wire:target="submitTest"
            ...
            <div class="bg-white rounded-lg shadow-sm p-8 text-center">
                <div class="mb-8">
                    @if($scoreData['percentage'] >= 70)
                        <div
                            class="w-24 h-24 bg-gradient-to-r from-green-400 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                    ...
                    @else
                        <div
                            class="w-24 h-24 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
