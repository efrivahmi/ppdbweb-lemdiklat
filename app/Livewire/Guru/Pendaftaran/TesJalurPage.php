...
class TesJalurPage extends Component
{
    ...
    public function delete($id)
    {
        try {
            ...
            $tes->delete();
            $this->dispatch("alert", message: "Test jalur berhasil di simpan", type: "success");
            $this->resetPage();
        } catch (\Exception $e) {
            $this->dispatch("alert", message: "Gagal menghapus, test jalur digunakan.", type: "error");
        }
    }
    ...
    public function saveCustomTests()
    {
        try {
            ...
            $this->dispatch("alert", message: "Berhasil di simpan", type: "success");
        } catch (\Exception $e) {
            $this->dispatch("alert", message: "Gagal menyimpan.", type: "error");
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.guru.pendaftaran.tes-jalur-page', [
            'tesJalurs' => $tesJalurs,
